...
/*   Updated: 2024/03/31 11:11:23 by martiper         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef bool (*t_cli_option_validator)(t_cli_option *option, char *arg);
...
enum e_cli_error_code
{
	...
	CLI_ERROR_INVALID_GENERIC_ARGUMENT,
	CLI_ERROR_INVALID_CHOICE_ARGUMENT,
...
#define CLI_ERROR_MSG_INVALID_CHOICE_ARGUMENT "invalid argument ‘%s’ for ‘%s’\nValid arguments are:\n%s"
#define CLI_ERROR_MSG_INVALID_GENERIC_ARGUMENT "invalid %s argument '%s'"
...
struct s_cli_option
{
	...
	t_cli_option_validator validator; // custom validator, runs after all the checks
	...
	void *data;			   // attach data to the option
...
struct s_cli_option_builder
{
	...
	t_cli_option_builder *(*set_custom_validator)(t_cli_option_validator validator);
